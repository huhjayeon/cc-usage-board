...
(function () {
  const STRINGS = {
    ko: {
      ...
      errEmptyData: '표시할 사용 기록이 없습니다. Claude Code를 사용한 뒤 ./update.sh를 다시 실행하세요.',
      errRunFirst: '터미널에서 먼저 실행:',
      insufficientData: '비교할 완료 월 부족',
      dow: ['일','월','화','수','목','금','토'],
      locale: 'ko-KR',
    ...
    en: {
      ...
      errEmptyData: 'No usage records to display. Use Claude Code, then re-run ./update.sh.',
      errRunFirst: 'Run in terminal first:',
      insufficientData: 'Not enough completed months',
